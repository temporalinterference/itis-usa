---
id: news-20251110-Computational-Modeling
---
...
We used the finite element method to create a model of the rat head, with a recording electrode positioned directly over the forelimb region and a reference electrode positioned over the hindlimb region of the somatosensory cortex. We used [Sim4Life](https://sim4life.swiss/) ([ZMT Zurich Med Tech](https://zmt.swiss/), Zurich, CH) to simulate a current applied between the electrodes and calculated the resulting electric potential generated in the rat head.

The scientific and technical impact of the study can be summarized as:

* We apply our previously developed reciprocity-theorem-based approach, whereby we simulate recordable signals from complex neural activity in heterogeneous anatomical environments, to study whisker-flick-evoked EEG in a rat mode

* We show that the rat somatosensory cortex model of the Blue Brain Project replicates many features of the in vivo whisker-flick-evoked EEG

* Leveraging the ability of simulations to isolate signal contributions, we attribute different components of the whisker-flick-evoked EEG to distinct neural populations and activity types

* We show that small changes to circuit connectivity can have a large impact on the EEG, even when firing rates remain unaffected, which suggests that EEG data can be used to constrain and validate in silico models
